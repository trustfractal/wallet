...
export const getSignedNounce = ([nounce, address]: [string, string]) =>
  EthereumProviderService.getSignedNounce(nounce, address);
...
const Callbacks = {
  ...
  [ConnectionTypes.GET_SIGNED_NOUNCE_INPAGE]: { callback: getSignedNounce },
